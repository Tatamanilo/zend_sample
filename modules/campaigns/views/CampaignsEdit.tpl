<form class="edit" accept-charset="utf-8" method="POST" id="campaignEditForm" action="">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <div id="files" class="files">
                    {if $campaign.logo}
                    <img src="{$offersUrl}{$campaign.logo}" height="70px" />
                    {/if}
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <div class="form-group input-group-sm">
                ...
                <div class="radio">
                    <label class="">
                        <input type="radio" name="form[campaignStatus]" value="E" {if $campaign.campaignStatus == 'E'}checked{/if} >Активный <i class="fa fa-check-circle text-success font16" title="test"></i>
                    </label>
                </div>
                <div class="radio">
                    <label class="">
            ...
            <div class="form-group input-group-sm">
                ...
                <div class="radio">
                    <label class="">
                        <input type="radio" name="form[campaignType]" value="P" {if $campaign.campaignType == 'P'}checked{/if} >Публичные <i class="fa fa-eye text-success font16"></i>
                    </label>
                </div>
                <div class="radio">
                    <label class="">
