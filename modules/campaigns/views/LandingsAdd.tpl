<form accept-charset="utf-8" method="POST" id="landingsAddForm" action="">
    ...
    <div class="form-group input-group-sm ">
        ...
        <input type="text" class="form-control" name="form[landingName]" value="" />
    </div>

    <div class="form-group input-group-sm">
        <label>{$messages.url}</label>
        <input type="text" class="form-control" name="form[url]" value="" />
    </div>
    ...
    <div class="form-group ">
        ...
        <textarea id="landingDescr" name="form[landingDescr]" class="form-control" rows="3"></textarea>
    </div>
    ...
    <div class="row">
        <div class="form-group input-group-sm col-lg-6">
            ...
            <div class="radio">
                <label class="">
                    <input type="radio" name="form[landingStatus]" value="E" {if $landing.landingStatus == 'E'}checked{/if} checked>Активный <i class="fa fa-check-circle text-success font16" title="test"></i>
                </label>
            </div>
            <div class="radio">
                <label class="">
        ...
        <div class="form-group input-group-sm col-lg-6">
            ...
            <div class="checkbox">
                <label class="">
                    <input type="checkbox" name="form[forPrivate]" value="1" {if $landing.forPrivate}checked{/if} checked>Приватный <i class="fa fa-users text-success font16" title="test"></i>
                </label>
            </div>
        </div>
    </div>
