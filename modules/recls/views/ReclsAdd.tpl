<form class="edit" accept-charset="utf-8" method="POST" id="reclAddForm" action="">
    <input type="hidden" name="ok" value="1">

    <div class="form-group">
        <label>{$messages.reclName}</label>
        <div class="form-group input-group-sm">
            <input type="text" class="form-control" name="form[reclName]" value="{$recl.reclName|escape:html}" />
        </div>
    </div>
    ...
    <div class="form-group input-group-sm">
        ...
        <div class="radio">
            <label class="">
                <input type="radio" name="form[reclStatus]" value="E" {if $recl.reclStatus == 'E'}checked{/if} checked>Активный <i class="fa fa-check-circle text-success font16" title="test"></i>
            </label>
        </div>
        <div class="radio">
            <label class="">
